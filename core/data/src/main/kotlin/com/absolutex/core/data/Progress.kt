 ...
 * is the one thing in here that cannot be regenerated by rescanning. Version 3 adds bookmarks, the
 * same way and for the same reason.
 */
@Database(
    entities = [ReadingProgress::class, LibraryBook::class, Bookmark::class],
    version = 3,
    exportSchema = true,
